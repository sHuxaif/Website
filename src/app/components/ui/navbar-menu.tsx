...
// Refactored MenuItem component with type annotations
...
// Define types for the Menu props
interface MenuProps {
  setActive: (item: string | null) => void;
  children: React.ReactNode;
}

// Refactored Menu component with type annotations
...
// Refactored ProductItem component with type annotations
...
// Refactored HoveredLink component with specific types
export const HoveredLink: React.FC<LinkProps> = ({  ...rest }) => {
  return (
